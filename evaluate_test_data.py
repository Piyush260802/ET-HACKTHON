...
TEST_FILES = [
    ("test_on_head_01.csv", "On Head"),
    ("test_on_belt_01.csv", "On Belt"),
    ("test_in_hand_01.csv", "In Hand"),
    ("test_on_surface_01.csv", "On Surface"),
]

PREDICTIONS_PATH = "data/processed/independent_test_predictions.csv"
CONFUSION_MATRIX_PATH = "data/processed/independent_test_confusion_matrix.png"
REPORT_PATH = "data/processed/independent_test_report.txt"
...
def save_confusion_matrix(cm, labels):
    ...
    plt.imshow(cm)
    plt.title("Bagimsiz Test Verisi - Confusion Matrix")
    plt.xlabel("Tahmin")
    plt.ylabel("Gercek")
...
def main():
    ...
    print("======================================")
    print("BAGIMSIZ TEST DEGERLENDIRMESI")
    print("======================================")
