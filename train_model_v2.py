...
CONFUSION_MATRIX_PATH = "data/processed/v2_internal_confusion_matrix.png"
REPORT_PATH = "data/processed/v2_internal_report.txt"
...
def save_confusion_matrix(cm, labels):
    ...
    plt.imshow(cm)
    plt.title("V2 Model - Ic Kontrol Confusion Matrix")
    plt.xlabel("Tahmin")
    plt.ylabel("Gercek")
...
def main():
    ...
    print("======================================")
    print("AKILLI BARET - V2 MODEL EGITIMI")
    print("======================================")
    print()
    print("Bu model 40 dakikalik ilk egitim verisi")
    print("+ 8 dakikalik ek egitim verisi ile egitilecek.")
    print()
    ...
    # Bundan sonra yeni test2 dosyalariyla sinanacaktir.
    # ======================================================

    print()
    print("Nihai V2 model tum egitim verisiyle egitiliyor...")
    ...
    report_text = ""
    report_text += "AKILLI BARET - V2 MODEL EGITIM RAPORU\n"
    report_text += "=====================================\n\n"
    ...
    report_text += "Bu sonuc yalnizca V2 model ic kontrol amaciyla uretilmistir.\n\n"
    ...
    print()
    print(f"V2 model kaydedildi: {MODEL_PATH}")
    print(f"V2 ic kontrol grafigi kaydedildi: {CONFUSION_MATRIX_PATH}")
    print(f"V2 ic kontrol raporu kaydedildi: {REPORT_PATH}")

    print()
    print("SONRAKI ADIM:")
    print("V2 model icin yeni bagimsiz test2 verileri toplanacak.")
